...
const EMPTY_BATTERY: BatteryForm = {
  ...
  maxBatteryToGridEnabled: false, maxBatteryToGridPowerKw: 0,
  cycleCostPerKwh: 0,
  ...
  const loadAll = useCallback(async () => {
    ...
    try {
      ...
      const bat: BatteryForm = {
        ...
        maxChargePowerKw: bat_s.maxChargePowerKw ?? 0,
        maxDischargePowerKw: bat_s.maxDischargePowerKw ?? 0,
        maxBatteryToGridEnabled: bat_s.maxBatteryToGridEnabled ?? false,
        maxBatteryToGridPowerKw: bat_s.maxBatteryToGridPowerKw ?? 0,
    ...
    try {
      const saved = await api.patch('/api/settings', {
        battery: {
          ...
          maxBatteryToGridEnabled: batteryForm.maxBatteryToGridEnabled,
          maxBatteryToGridPowerKw: batteryForm.maxBatteryToGridPowerKw,
