  ...
  useEffect(() => {
    ...
    const settingsPromise = api.get('/api/settings').then(res => {
      ...
      setBatteryForm(f => ({
        ...
        maxBatteryToGridEnabled: bat.maxBatteryToGridEnabled     ?? f.maxBatteryToGridEnabled,
        maxBatteryToGridPowerKw: bat.maxBatteryToGridPowerKw     ?? f.maxBatteryToGridPowerKw,
